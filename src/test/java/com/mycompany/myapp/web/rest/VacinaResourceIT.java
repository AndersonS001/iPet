...
class VacinaResourceIT {
    ...
    private static final TipoVacina DEFAULT_TIPO = TipoVacina.ANTIRRABICA;
    private static final TipoVacina UPDATED_TIPO = TipoVacina.GRIPE;
    ...
    public static Vacina createEntity(EntityManager em) {
        Vacina vacina = new Vacina().nome(DEFAULT_NOME).dataAplicacao(DEFAULT_DATA_APLICACAO).tipo(DEFAULT_TIPO);
        return vacina;
    }
    ...
    public static Vacina createUpdatedEntity(EntityManager em) {
        Vacina vacina = new Vacina().nome(UPDATED_NOME).dataAplicacao(UPDATED_DATA_APLICACAO).tipo(UPDATED_TIPO);
        return vacina;
    }
    ...
    void createVacina() throws Exception {
        ...
        assertThat(testVacina.getTipo()).isEqualTo(DEFAULT_TIPO);
    }
    ...
    void putNewVacina() throws Exception {
        ...
        updatedVacina.nome(UPDATED_NOME).dataAplicacao(UPDATED_DATA_APLICACAO).tipo(UPDATED_TIPO);
        ...
        assertThat(testVacina.getTipo()).isEqualTo(UPDATED_TIPO);
    }
    ...
    void partialUpdateVacinaWithPatch() throws Exception {
        ...
        partialUpdatedVacina.dataAplicacao(UPDATED_DATA_APLICACAO);
    ...
    void fullUpdateVacinaWithPatch() throws Exception {
        ...
        partialUpdatedVacina.nome(UPDATED_NOME).dataAplicacao(UPDATED_DATA_APLICACAO).tipo(UPDATED_TIPO);
